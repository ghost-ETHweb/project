...
export const shopsData = [
  ...
  { id: 16, name: "БЕГЕМОТиК", category: "Детский магазин", floor: 1, logo: "/images/shops/БЕГЕМОТиК/0.png", hint: "kids store", description: "Сеть магазинов игрушек и товаров для детей.", images: ["/images/shops/БЕГЕМОТиК/1.png"], promotions: [], workingHours: "10:00 - 21:00", phone: "(123) 555-1616" },
