...
export const shopsData: Shop[] = [
  ...
  { id: 23, name: "Все инструменты.ру", category: "Инструменты", floor: 1, logo: "/images/shops/vseinstrumenti/0-vseinstrumenti.webp", hint: "tools logo", description: "Профессиональный инструмент и оборудование для строительства и ремонта.", images: ["/images/shops/vseinstrumenti/1-vseinstrumenti.jpg", "/images/shops/vseinstrumenti/2-vseinstrumenti.jpg", "/images/shops/vseinstrumenti/3-vseinstrumenti.jpg", "/images/shops/vseinstrumenti/4-vseinstrumenti.jpg"], promotions: [], workingHours: "09:00 - 20:00", phone: "(123) 555-2424" },
